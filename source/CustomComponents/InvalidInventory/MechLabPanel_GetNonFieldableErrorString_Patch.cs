...
public static class MechLabPanel_GetNonFieldableErrorString_Patch
{
    ...
    public static IEnumerable<CodeInstruction> Transpiler(IEnumerable<CodeInstruction> instructions)
    {
        return instructions.MethodReplacer(
            AccessTools.Method(typeof(MechValidationRules), nameof(MechValidationRules.GetValidationErrors)),
            AccessTools.Method(typeof(MechLabPanel_GetNonFieldableErrorString_Patch), nameof(GetValidationErrors))
        );
    }
